            ...
            background:
              selectedMode === 'fun'
                ...
                : selectedMode === 'professional'
                  ...
                  : selectedMode === 'ultra'
                    ? 'radial-gradient(circle at 80% 20%, rgba(239,68,68,0.15), transparent 50%)'
        ...
        <div className='container mx-auto px-4 md:px-8 py-24 md:py-32 max-w-7xl flex-1 flex flex-col'>
          ...
          >
            ...
            <p className='text-white/40 font-medium max-w-xl text-lg'>
              Select a protocol to define the capabilities, security level, and visual identity of
              your workspace.
            </p>
          </motion.div>
          ...
          <div className='grid lg:grid-cols-12 gap-12 flex-1'>
                ...
                return (
                  ...
                  >
                    ...
                    <div className='relative z-10 flex-1 flex flex-col'>
                      ...
                      <h3
                        className={`text-2xl font-black uppercase tracking-tight mb-2 ${isSelected ? 'text-white' : 'text-white/70 group-hover:text-white'}`}
                      >
                        {config.label}
                      </h3>
                      ...
                      <div className='mt-auto flex flex-wrap gap-2'>
                        ...
                        {config.securityLevel === 'high' && (
                          <span className='px-2 py-1 rounded bg-red-500/10 text-[10px] font-bold uppercase tracking-wider text-red-500'>
                            Max Security
                          </span>
                        )}
                      </div>
            ...
            <div className='lg:col-span-4 flex flex-col gap-6'>
              ...
              <div className='flex-1 bg-gradient-to-b from-[#0c1016] to-transparent border border-white/5 rounded-[2.5rem] p-8 relative overflow-hidden'>
                <h4 className='text-xs font-black uppercase tracking-widest text-white/30 mb-6'>
                  Protocol Details
                </h4>
                ...
                <div className='space-y-4 relative z-10'>
                  ...
                  <FeatureRow
                    ...
                    active={currentConfig.features.virtualBrowser}
                  />
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span
                      className={`px-2 py-1 rounded text-[10px] font-black uppercase tracking-widest ${
                        currentConfig.securityLevel === 'high'
                          ? 'bg-red-500/20 text-red-500'
                          : currentConfig.securityLevel === 'medium'
...
const FeatureRow = ({ label, active }: { label: string; active: boolean }) => (
  <div className='flex items-center justify-between'>
    ...
    <div
      className={`w-8 h-5 rounded-full flex items-center p-1 transition-colors ${active ? 'bg-emerald-500' : 'bg-white/10'}`}
    >
      <div
        className={`w-3 h-3 rounded-full bg-white shadow-sm transition-transform ${active ? 'translate-x-3' : 'translate-x-0'}`}
      />
    </div>
  </div>
);
