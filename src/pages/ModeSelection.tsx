    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-indigo-500/30 overflow-hidden relative">
            ...
            <div className="fixed inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-900/10 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
            </div>
            ...
            <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    >
                        Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-white">Environment</span>
                    </motion.h1>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Every conversation has a purpose. Cospira adapts the room's intelligence, security, and tools to match your intent.
                    </motion.p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                    {modes.map((mode, index) => (
                        ...
                        >
                            <div className={`absolute inset-0 ${mode.bg} opacity-0 ${mode.hover} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                            
                            <div className="relative z-10 flex items-start gap-6">
                                <div className={`w-14 h-14 rounded-2xl ${mode.bg} flex items-center justify-center shrink-0 border ${mode.border}`}>
