        ...
        <div className='flex flex-col md:flex-row md:items-center justify-between gap-6'>
          <div>
            <h1 className='text-4xl md:text-5xl font-black italic tracking-tighter uppercase mb-2'>
              Combat <span className='text-indigo-400'>Hub</span>
            </h1>
            <p className='text-white/40 font-bold uppercase tracking-widest text-xs'>
              Enter the arena and claim your dominance
            </p>
          </div>
          ...
          >
            <div className='absolute inset-0 bg-black'>
              <img
                ...
                className='absolute inset-0 w-full h-full object-cover opacity-50 transition-transform group-hover:scale-105 duration-[10000ms]'
              />
            ...
            <div className='relative z-10 h-full flex flex-col justify-center px-12 py-16 max-w-2xl'>
              <div className='flex items-center gap-3 mb-6'>
                <span className='px-3 py-1 rounded-full bg-indigo-500 text-white text-[10px] font-black uppercase tracking-widest shadow-lg'>
                  Season Event
                </span>
              ...
              <h2 className='text-5xl md:text-6xl font-black text-white italic tracking-tighter uppercase mb-6 leading-none'>
                {featuredGame.name}
              </h2>
              <p className='text-md text-white/70 max-w-md font-medium leading-relaxed mb-10 border-l-2 border-indigo-500 pl-6 lowercase first-letter:uppercase'>
                {featuredGame.desc}
              </p>
              <div className='flex items-center gap-4'>
                <button
                  onClick={() => {
                    playClick();
                    setSelectedGame(featuredGame.id as GameId);
                  }}
                ...
                <button className='h-14 px-8 bg-white/5 border border-white/10 rounded-2xl text-white font-black uppercase tracking-widest hover:bg-white/10 transition-all text-xs'>
                  Details
                </button>
              </div>
            </div>
            ...
            <div className='h-full flex flex-col bg-[#0c1016]/40 backdrop-blur-xl border border-white/5 rounded-[32px] p-8'>
              ...
              <div className='space-y-4 flex-1'>
                {tournaments.map((t) => (
                  <div
                    key={t.id}
                    className={`p-6 rounded-2xl bg-gradient-to-br ${t.color} border border-white/5 hover:border-white/20 transition-all cursor-pointer group`}
                  >
              ...
              {competitiveGames.map((game) => (
                ...
                >
                  ...
                  <div className='absolute bottom-0 left-0 right-0 p-6'>
                    <span className='text-[9px] font-black text-white/40 uppercase tracking-widest block mb-2'>
                      {game.category}
                    </span>
              ...
              {casualGames.map((game) => (
                ...
                >
                  ...
                  <div className='flex-1'>
                    <h4 className='text-sm font-black text-white uppercase italic leading-none mb-1'>
                      {game.name}
                    </h4>
            ...
            >
              <div className='h-40 relative'>
                <img
                  ...
                  alt={getCurrentGame()?.name}
                  className='w-full h-full object-cover opacity-30'
                />
                <div className='absolute inset-0 bg-gradient-to-t from-[#0b1220] to-transparent' />
                <div className='absolute bottom-8 left-10'>
                  <span className='text-[10px] font-black uppercase tracking-[0.4em] text-indigo-400 mb-2 block'>
                    Protocol Initiation
                  </span>
                ...
                <button
                  ...
                  className='absolute top-6 right-6 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white'
                >
                  <X size={20} />
                </button>
              </div>
            ...
            >
              ...
              <div className='space-y-4'>
                ...
                <p className='text-slate-400 font-medium tracking-wide'>
                  Searching for available opponents in the{' '}
                  <span className='text-indigo-400 font-bold'>{getCurrentGame()?.name}</span> arena.
                </p>
              </div>
