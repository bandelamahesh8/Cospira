...
import { 
  Zap, Lock,
  Activity, FileText, CheckCircle2, Sparkles, Play
} from 'lucide-react';
...
const SemanticMatching = () => {
    ...
    useEffect(() => {
        const loop = async () => {
            while (true) {
                setStep(0); await new Promise(r => setTimeout(r, 2000));
                setStep(1); await new Promise(r => setTimeout(r, 1500)); // Labels
                setStep(2); await new Promise(r => setTimeout(r, 1000)); // Nodes appear
                setStep(3); await new Promise(r => setTimeout(r, 3000)); // Match lock
                setStep(4); await new Promise(r => setTimeout(r, 1000)); // Dissolve
    ...
    return (
        <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden rounded-[3rem] bg-black border border-white/5 shadow-2xl">
                            ...
                            >
                                ...
                                {isMatch && step === 3 && (
                                     <svg className="absolute top-1/2 left-1/2 w-[300px] h-[300px] -translate-x-1/2 -translate-y-1/2 pointer-events-none overflow-visible">
                                         <motion.line 
                                            x1="50%" y1="50%" 
                                            x2="150" y2="150" // To Center (relative to svg center 150,150)
                                         />
                                     </svg>
                                )}
                            </motion.div>
            ...
            {step === 3 && (
             ...
             >
                <div className={`absolute inset-0 rounded-full bg-white/5 ${step === 3 ? 'bg-emerald-500/20' : ''}`} />
                <span className={`font-bold text-[10px] tracking-widest ${step === 3 ? 'text-emerald-400' : 'text-white'}`}>YOU</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 relative">
             ...
             >
                ...
                <div className="mt-8 pt-4 border-t border-white/5 disabled:border-red-500/10">
                    <p className="text-sm text-red-400/60 font-mono">Status: Chaotic, Unstructured, Forgettable.</p>
                </div>
             </motion.div>
             ...
             >
                 ...
                 <div className="relative z-10 space-y-6">
                     ...
                     <div className="space-y-3">
                        ...
                        <p className="pl-6 text-white/70 text-sm">Assigned to @Sarah: Draft budget by Friday.</p>
                     </div>
                 </div>
                 ...
                 <div className="mt-8 pt-4 border-t border-indigo-500/20">
                    <p className="text-sm text-indigo-300/80 font-mono flex items-center gap-2">
                        <Sparkles className="w-3 h-3 animate-pulse" /> Intelligence that disappears when you don't need it.
                    </p>
                </div>
             </motion.div>
        </div>
    ...
    >
      ...
      <section className='relative min-h-[90vh] flex flex-col justify-center items-center pt-20 px-4'>
            ...
            <div className="fixed inset-0 z-0 bg-[#050505] pointer-events-none">
                 ...
                 <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-indigo-900/10 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '1s' }} />
