            ...
            <div className="relative max-w-7xl mx-auto px-6 py-20 lg:px-8 space-y-32">
                ...
                >
                    <motion.div variants={itemVariants} className="relative group cursor-default">
                        ...
                        <div className="relative flex items-center gap-3 px-6 py-2 bg-black rounded-xl border border-white/10">
                            ...
                            <span className="text-xs font-bold tracking-[0.2em] uppercase text-white/60">System Online v4.2.0</span>
                        </div>
                    </motion.div>

                    <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter uppercase italic leading-[0.85]">
                        <span className="text-white/20 block text-4xl md:text-5xl lg:text-6xl mb-4 not-italic font-bold tracking-normal opacity-50">Welcome to</span>
                        Cospira <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-400 to-purple-400">OS</span>
                    </motion.h1>

                    <motion.p variants={itemVariants} className="text-xl md:text-2xl text-slate-400 max-w-3xl leading-relaxed font-light">
                        The definitive platform for <span className="text-white font-medium">real-time cognitive collaboration</span>. 
                        Merging secure communication, AI-driven analytics, and decentralized social mesh networking into a single, cohesive operating environment.
                    </motion.p>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3 text-cyan-400 mb-2">
                                    ...
                                    <h3 className="text-sm font-black uppercase tracking-[0.2em]">Live Neural Mesh</h3>
                                </div>
                            ...
                            <p className="max-w-md text-sm text-slate-400 leading-relaxed text-right md:text-left">
                                Tracking active nodes, encrypted data streams, and synchronized user sessions across the global Cospira network in real-time.
                            </p>
                        </div>
                    </div>
                ...
                <section>
                    <div className="flex items-center gap-4 mb-16">
                        ...
                        <h2 className="text-2xl font-black uppercase tracking-widest italic text-white/80">System Architecture</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            >
                                <div className={`w-14 h-14 rounded-2xl bg-black/50 border border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform ${item.color}`}>
                                    <item.icon size={28} />
                                </div>
                                <h3 className="text-xl font-bold uppercase tracking-tight mb-3 group-hover:text-white transition-colors">{item.title}</h3>
                ...
                <section className="space-y-20">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-2xl font-black uppercase tracking-widest italic text-white/80">Operational Manual</h2>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                ...
                                <h4 className="text-2xl font-black uppercase italic text-blue-400 mb-4">Standard</h4>
                                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                                    Optimized for high-stakes professional collaboration. Prioritizes audio clarity, screen sharing, and document syncing.
                                </p>
                            ...
                            >
                                ...
                                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                                    Casual environments for hanging out. Enables media sharing, YouTube sync, and relaxed layouts.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/60">
                            ...
                            >
                                ...
                                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                                    High-performance mode with overlay supports, game state synchronization, and competitive tools.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/60">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[
                                { icon: Globe, label: "Virtual Browser", desc: "Launch a shared, cloud-hosted browser instance inside the room." },
                                { icon: Command, label: "AI Summary", desc: "Generate instant transcripts and action items via Gemini 1.5." },
                                { icon: Radio, label: "YouTube Sync", desc: "Frame-perfect video synchronization for all participants." },
                                { icon: Terminal, label: "Code Editor", desc: "Real-time collaborative monaco editor with syntax highlighting." },
                                { icon: Shield, label: "Security", desc: "Toggle room lock, waiting room, and encryption keys." },
                                { icon: Activity, label: "Analytics", desc: "View connection quality and neural mesh latency stats." },
                                { icon: Lock, label: "Private Mode", desc: "Sever external links and go dark for maximum privacy." },
                                { icon: Zap, label: "Turbo Mode", desc: "reduce stream quality to prioritize audio latency." },
                            ].map((ctrl, i) => (
                                <div key={i} className="p-6 rounded-2xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] transition-colors">
                                    ...
                                    <h5 className="text-sm font-bold uppercase tracking-wider text-white mb-2">{ctrl.label}</h5>
                ...
                <footer className="border-t border-white/10 pt-20 pb-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                        <div className="space-y-6">
                            <h3 className="text-3xl font-black uppercase italic tracking-tighter">Cospira <span className="text-indigo-500">Labs</span></h3>
                            <p className="text-slate-500 max-w-sm">
                                Built for the future of work and play. We are a distributed team of engineers, designers, and futurists.
                            </p>
                        </div>
                        <div className="flex flex-col items-start md:items-end justify-between space-y-6">
                            <div className="flex gap-4">
                                <Button variant="ghost" className="text-xs uppercase tracking-widest text-white/40 hover:text-white">Terms</Button>
                                <Button variant="ghost" className="text-xs uppercase tracking-widest text-white/40 hover:text-white">Privacy</Button>
                                <Button variant="ghost" className="text-xs uppercase tracking-widest text-white/40 hover:text-white">Status</Button>
                            </div>
                            <div className="text-right">
                                <p className="text-[10px] uppercase tracking-widest text-emerald-500 font-bold mb-1">● All Systems Operational</p>
                                <p className="text-xs text-white/20 font-mono">Server Time: {new Date().toISOString()}</p>
                            </div>
                        </div>
                    </div>
