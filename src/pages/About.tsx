...
import { 
    Video, Zap, Bot,
    Shield, Globe, Cpu, Database, Code2, 
    Shuffle, Box, ArrowRight,
    Users, Mail, MessageSquare, ChevronDown,
    Lock, EyeOff, Trash2
} from 'lucide-react';
        ...
        <div className='min-h-screen bg-[#050505] relative overflow-x-hidden font-sans selection:bg-indigo-500/30 text-white'>
            ...
            <div className="relative z-10">
                ...
                <section className='container mx-auto px-4 pt-40 pb-32 text-center'>
                    ...
                    >
                        <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/10 text-white/40 mb-4 backdrop-blur-md'>
                            ...
                            <span className='text-[10px] font-black tracking-[0.2em] uppercase'>The Cospira Protocol</span>
                        </div>
                        
                        <h1 className='text-6xl md:text-9xl font-black tracking-tighter leading-[0.85] uppercase'>
                            BEYOND<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">VIDEO CALLS.</span>
                        </h1>
                        
                        <div className="space-y-4 max-w-2xl mx-auto">
                            <p className='text-xl md:text-2xl text-white/50 leading-relaxed font-medium'>
                                Most platforms optimize for attention.<br />
                                <span className="text-white">Cospira is built for intention.</span>
                            </p>
                            <p className='text-base text-white/30 leading-relaxed'>
                                We're re-engineering how people meet online. It's not just about seeing faces; 
                                it's about sharing experiences, breaking bubbles, and collaborating without friction.
                            </p>
                        </div>
                    </motion.div>
                </section>
                ...
                <section id="how-it-works" className="py-32 px-4 bg-white/[0.01] border-y border-white/5">
                    <div className="container mx-auto max-w-6xl">
                        <motion.div {...fadeInUp} className="text-center mb-20 space-y-4">
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight uppercase">How Cospira Works</h2>
                            <p className="text-white/40 max-w-xl mx-auto text-lg">A simple system designed around control, privacy, and real connection.</p>
                        </motion.div>
                ...
                <section className="py-32 px-4">
                    <div className="container mx-auto max-w-6xl">
                        <motion.div {...fadeInUp} className="text-center mb-20 space-y-4">
                            ...
                            <p className="text-white/40 max-w-xl mx-auto text-lg text-lowercase underline underline-offset-8 decoration-white/10">The Cospira Experience Toolkit</p>
                        </motion.div>
                        ...
                        <div className="grid md:grid-cols-3 gap-12">
                            <motion.div {...fadeInUp} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <ul className="space-y-2">
                                        {['Whiteboard integration', 'Instant Screen Sharing', 'Shared Media Hub'].map((item, i) => (
                                            <li key={i} className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-white/30">
                                                <div className="w-1 h-1 rounded-full bg-indigo-500" />
                                                {item}
                                            </li>
                                        ))}
                                    </ul>
                                    <p className="text-xs font-bold text-white pt-2">Rooms feel owned — not hosted.</p>
                                </div>
                            </motion.div>
                            ...
                            <motion.div {...fadeInUp} transition={{ delay: 0.1 }} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <p className="text-white/50 text-sm leading-relaxed">
                                        Intent-based matching with language and interest signals. No endless scrolling or addiction loops.
                                    </p>
                                    <ul className="space-y-2">
                                        {['Interest Matching', 'Serendipity Engine', 'Bubble Breaking'].map((item, i) => (
                                            <li key={i} className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-white/30">
                                                <div className="w-1 h-1 rounded-full bg-indigo-500" />
                                                {item}
                                            </li>
                            ...
                            <motion.div {...fadeInUp} transition={{ delay: 0.2 }} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <p className="text-white/50 text-sm leading-relaxed">
                                        Optional AI assistants that help you work, not watch you. Real-time summarizes and translations.
                                    </p>
                                    <ul className="space-y-2">
                                    ...
                                    <p className="text-xs font-bold text-white pt-2">Intelligence that assists — not observes.</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section id="privacy" className="py-32 px-4 bg-white/[0.02]">
                    <div className="container mx-auto max-w-4xl text-center">
                        <motion.div {...fadeInUp} className="space-y-6 mb-16">
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight uppercase">Privacy Is the Product</h2>
                            <div className="w-20 h-1 bg-white mx-auto rounded-full" />
                        </motion.div>

                        <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 text-left mb-16">
                            {[
                                { icon: EyeOff, title: "No Behavior Tracking", text: "We don't watch how you move or who you talk to." },
                                { icon: Shield, title: "No Data Resale", text: "Your data is not our commodity. We don't sell info." },
                                { icon: Lock, title: "E2E Encryption", text: "Your rooms are locked from the outside. Always." },
                                { icon: Box, title: "No Recordings", text: "System-level block on shadow recording. Sessions are transient." },
                                { icon: Users, title: "No Ads", text: "Zero advertising. Your focus is not for sale." },
                                { icon: Zap, title: "Instant Deletion", text: "Leave a room, and the data footprint vanishes." }
                            ].map((item, i) => (
                                <motion.div 
                                    key={i}
                                    {...fadeInUp}
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 className="font-bold text-white mb-1 uppercase tracking-tight text-sm">{item.title}</h4>
                        ...
                        <motion.p {...fadeInUp} className="text-xl md:text-2xl font-black uppercase tracking-tight text-white/20 italic">
                ...
                <section className="py-32 px-4 border-b border-white/5">
                    <div className="container mx-auto max-w-5xl">
                         <motion.div {...fadeInUp} className="text-center mb-16 space-y-4">
                            <h2 className="text-3xl font-black tracking-tight uppercase">Built to Disappear When You’re Done</h2>
                            <p className="text-white/30 text-sm">Infrastructure exists to support experience — not dominate it.</p>
                         </motion.div>
                         ...
                         <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                             {[
                                 ...
                                 >
                                     ...
                                     <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-white/50">{tech.label}</span>
                                 </motion.div>
                             ))}
                         </div>
                    </div>
                ...
                <section id="contact-section" className="py-32 px-4 bg-white/[0.01]">
                    <div className="container mx-auto max-w-5xl">
                        <motion.h2 {...fadeInUp} className="text-4xl md:text-5xl font-black tracking-tight uppercase text-center mb-20">Talk to Us</motion.h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/20">General Support</label>
                                        <p className="text-lg font-bold text-white hover:text-indigo-400 transition-colors cursor-pointer">support@cospira.com</p>
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/20">Security & Privacy</label>
                                        <p className="text-lg font-bold text-white hover:text-indigo-400 transition-colors cursor-pointer">security@cospira.com</p>
                                    </div>
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        <p className="text-white/50 text-sm leading-relaxed">
                                            Feedback is reviewed manually. No automated black holes. The product evolves directly from user signals and real needs.
                                        </p>
                                        <div className="grid grid-cols-1 gap-3">
                                            {[
                                                ...
                                                <div key={i} className="flex flex-col gap-1">
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400/80">{item.label}</span>
                ...
                <section id="legal-section" className="py-32 px-4 border-t border-white/5">
                    <div className="container mx-auto max-w-4xl">
                        <motion.h2 {...fadeInUp} className="text-center text-3xl font-black uppercase tracking-tight mb-16 text-white/30">Your Rights on Cospira</motion.h2>
                        ...
                        <div className="space-y-4">
                            {[
                                { 
                                    ...
                                    content: 'We collect minimal technical data required for room stability. We never collect or store your conversations, facial data, or personal browsing habits. All transient data is purged upon session termination.' 
                                },
                                { 
                                    id: 'terms', 
                                    title: 'Terms of Service (Summary)', 
                                    content: 'Cospira is a platform for open but respectful connection. Malicious usage, illegal streaming, or harassment results in instant system-level bans. You own your content; we merely provide the conduit.' 
                                }
                            ].map((item) => (
                                <motion.div 
                                    key={item.id}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <ChevronDown className={`w-5 h-5 transition-transform duration-500 ${expandedLegal === item.id ? 'rotate-180' : ''}`} />
                                    </button>
                                    <AnimatePresence>
                                        {expandedLegal === item.id && (
                                            ...
                                            >
                                                <div className="p-6 pt-0 space-y-6">
                                                    ...
                                                    <Button variant="outline" className="h-10 rounded-xl text-[10px] font-black uppercase tracking-widest border-white/10 hover:bg-white/5">
