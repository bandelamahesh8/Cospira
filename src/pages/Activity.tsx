                ...
                >
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-200">Neural Memory</span>
                        </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="px-6 py-4 bg-white/[0.03] border border-white/5 rounded-3xl backdrop-blur-xl flex flex-col items-center min-w-[140px]">
                            <span className="text-[9px] font-black uppercase tracking-widest text-white/20 leading-none mb-2">Total Cycles</span>
                            <span className="text-3xl font-black text-white italic tracking-tighter">{totalRooms}</span>
                        </div>
                        <div className="px-6 py-4 bg-indigo-500/10 border border-indigo-500/20 rounded-3xl backdrop-blur-xl flex flex-col items-center min-w-[140px]">
                            <span className="text-[9px] font-black uppercase tracking-widest text-indigo-400/50 leading-none mb-2">Avg Depth</span>
                            <span className="text-3xl font-black text-indigo-400 italic tracking-tighter">{avgDuration}</span>
                        </div>
                    </div>
                </motion.div>
                    ...
                    <div className="xl:col-span-8 space-y-8">
                        ...
                        {loading ? (
                                ...
                                {Object.entries(groupedActivities).map(([group, groupActivities], i) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute -left-[54px] top-0 flex items-center bg-[#05070a] py-2 border border-white/5 rounded-xl px-3 min-w-[80px] justify-center z-10 shadow-2xl">
                                            <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">{group.split(',')[0]}</span>
                                        </div>
                            ...
                            <div className="text-center py-32 bg-[#0c1016]/40 backdrop-blur-xl rounded-[40px] border border-dashed border-white/5 flex flex-col items-center">
                                ...
                                <h3 className="text-2xl font-black text-white italic uppercase tracking-tighter">Memory Bank Empty</h3>
                                <p className="text-[10px] text-white/20 mt-2 font-black uppercase tracking-[0.2em] max-w-xs">No activity signatures detected in your neural history logs.</p>
                            ...
                            <div className="mt-12 pt-12 border-t border-white/5 space-y-6">
                                <div className="flex items-center gap-4 opacity-50">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[9px] font-black uppercase tracking-widest leading-none mb-1">Last Update</span>
                                ...
                                <div className="flex items-center gap-4 opacity-50">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[9px] font-black uppercase tracking-widest leading-none mb-1">Archival Protocol</span>
