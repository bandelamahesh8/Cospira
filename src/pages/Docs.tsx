      ...
      items: [
        {
          icon: Rocket,
          label: 'Core Concept',
          desc: 'Understand the Cospira network architecture.',
        },
        {
          icon: Users,
          label: 'Identity Matrix',
          desc: 'Neural signatures and user authentication.',
        },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Lock, label: 'Private Sectors', desc: 'Password-protected and hidden room logic.' },
        {
          icon: FileText,
          label: 'Asset Sharing',
          desc: 'Secure file propagation and presentation.',
        },
      ],
    },
  ];
        ...
        >
          <div className='space-y-4'>
            ...
            <p className='text-lg text-white/40 font-medium max-w-2xl leading-relaxed uppercase tracking-tight text-sm'>
              Master the Cospira environment with our comprehensive protocol documentation and
              system guidelines.
            </p>
          </div>
          ...
          <div className='flex items-center gap-4 bg-white/[0.03] border border-white/5 p-6 rounded-[32px] backdrop-blur-xl'>
            <div className='flex flex-col items-end'>
              <span className='text-[8px] font-black uppercase tracking-[0.2em] text-white/20 mb-1'>
                Current Version
              </span>
          ...
          {DOC_SECTIONS.map((section, sIdx) => (
            <div key={sIdx} className='space-y-8'>
              <div className='flex items-center gap-4'>
                <h2 className='text-[11px] font-black uppercase tracking-[0.4em] text-white/20 whitespace-nowrap'>
                  {section.title}
                </h2>
                  ...
                  >
                    ...
                    <div className='flex items-center gap-6 relative z-10'>
                      ...
                      <div className='flex-1'>
                        <h3 className='text-2xl font-black text-white uppercase italic tracking-tighter group-hover:text-emerald-400 transition-colors'>
                          {item.label}
                        </h3>
          ...
          <div className='space-y-4'>
            <div className='flex items-center gap-3'>
              ...
              <h2 className='text-3xl font-black text-white italic uppercase tracking-tighter'>
                Global <span className='text-white/20'>Uplink</span>
              </h2>
            </div>
            <p className='text-sm font-bold text-white/30 uppercase tracking-[0.1em] max-w-lg leading-relaxed'>
              Access our full API reference and developer console for enterprise-level automation
              and deep-scale integrations.
            </p>
          </div>
