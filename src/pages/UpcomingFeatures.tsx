                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <span className="text-xs font-black uppercase tracking-[0.2em] text-pink-200">Roadmap 2026</span>
                        </motion.div>
                        ...
                        >
                            We are building the future of collaborative computing. Here is what's launching next in the Cospira ecosystem.
                        </motion.p>
                    </div>
                                    ...
                                    <div className="flex items-start gap-6">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                <h3 className="text-2xl font-black text-white uppercase italic">{feature.title}</h3>
                                            ...
                                            <p className="text-white/40 font-medium max-w-lg leading-relaxed">{feature.description}</p>
                                        </div>
                                    </div>
                                    
                                    <div className="flex items-center gap-4 pl-22 md:pl-0">
                                        <div className="flex flex-col md:items-end">
                                            <span className="text-[10px] font-black uppercase tracking-widest text-white/20">Target Launch</span>
                    ...
                    <div className="py-12 text-center">
                        <p className="text-white/20 text-sm font-bold uppercase tracking-widest">
                            Have a request? <button onClick={() => navigate('/feedback')} className="text-pink-400 hover:underline">Submit Protocol Feedback</button>
                        </p>
                    </div>
                </div>
            </div>
