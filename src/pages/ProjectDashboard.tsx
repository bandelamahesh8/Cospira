...
import { Zap, Activity, Box, LayoutGrid, Settings, Users } from 'lucide-react';
import { toast } from 'sonner';

const ProjectDashboard = () => {
  const handleCreateResource = () => {
    toast.success('Resource Provisioning Init', {
      description: 'Cloud Room creation in Project Scope is coming in Phase 3.',
    });
  };
        ...
        <main className='flex-1 container mx-auto px-4 md:px-8 py-24 max-w-7xl'>
          ...
          <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12'>
            ...
            <div className='flex items-center gap-3'>
              <Button
                variant='outline'
                className='h-12 border-white/10 text-white bg-white/5 hover:bg-white/10 gap-2'
              >
