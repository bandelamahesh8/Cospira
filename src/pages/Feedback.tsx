          ...
          >
            ...
            <div className='space-y-4'>
              <p className='text-xl text-white/50 leading-relaxed font-medium'>
                Every message is reviewed by the product team —{' '}
                <span className='text-white'>not an algorithm.</span>
              </p>
            ...
            >
                ...
                <CardHeader className='p-10 pb-6'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-4'>
                      <div
                        className={`w-14 h-14 rounded-2xl bg-white/[0.05] border border-white/10 flex items-center justify-center ${selectedType?.color}`}
                      >
                      ...
                      <div>
                        ...
                        <CardDescription className='text-white/30'>
                          Direct channel to Cospira engineering
                        </CardDescription>
                      </div>
                    </div>
                  </div>
                          ...
                          <motion.button
                            ...
                            className={`w-full h-16 rounded-full font-black uppercase tracking-[0.2em] text-[10px] transition-all relative overflow-hidden group flex items-center justify-center gap-3 ${
                              isSubmitting
                                ...
                                : 'bg-white text-black hover:shadow-[0_0_40px_rgba(255,255,255,0.25)]'
                            }`}
              ...
              >
                ...
                <p className='text-sm text-white/40 leading-relaxed text-center sm:text-left'>
                  "Recent feedback helped us improve{' '}
                  <span className='text-white/60'>matching speed</span> and{' '}
                  <span className='text-white/60'>UI clarity</span>. We build based on signals — not
                  assumptions."
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <Card className='luxury-card bg-white/[0.03] border-white/5 p-8 rounded-[2rem] space-y-4'>
                <div className='flex items-center gap-3'>
                  ...
                  <h3 className='text-lg font-black uppercase tracking-tight text-white/50'>
                    Direct Reach
                  </h3>
                </div>
                <div className='space-y-4'>
