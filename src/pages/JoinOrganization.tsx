...
const JoinOrganization = () => {
  ...
  const [status, setStatus] = useState<'verifying' | 'preview' | 'accepting' | 'success' | 'error'>(
    'verifying'
  );
        ...
        <div className='relative z-10 flex flex-col items-center text-center'>
          ...
          {status === 'preview' && inviteDetails && (
            <>
              ...
              <p className='text-white/60 text-sm mb-6'>
                ...
                <span className='text-white font-bold block mt-1 text-lg'>
          ...
          {status === 'error' && (
            <>
              ...
              <p className='text-red-400/80 text-sm mb-6 max-w-[80%] mx-auto'>{errorMessage}</p>
              <Button
                variant='outline'
                onClick={() => navigate('/dashboard')}
