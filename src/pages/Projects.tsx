              ...
              {filteredProjects.map((project) => (
                ...
                >
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant='ghost'
                          size='icon'
                          className='h-8 w-8 text-white/20 hover:text-white rounded-full'
                        >
                  ...
                  <div className='absolute bottom-6 right-6'>
                    <div
                      className={`w-2 h-2 rounded-full ${project.status === 'active' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]' : 'bg-gray-500'}`}
                    />
                  </div>
                </motion.div>
              ))}
          ...
          <DialogContent className='bg-[#0c1016] border-white/10 sm:max-w-[425px]'>
            <DialogHeader>
              <DialogTitle className='text-white'>
                Assign Team to {selectedProject?.name}
              </DialogTitle>
            </DialogHeader>
