...
export const SHOP_ITEMS: ShopItem[] = [
  {
    ...
    type: 'frame',
    price: 500,
    asset: 'ring-4 ring-yellow-400 shadow-[0_0_20px_rgba(250,204,21,0.5)]',
  },
  {
    id: 'frame_fire',
    name: 'Inferno',
    type: 'frame',
    price: 1000,
    asset: 'ring-4 ring-orange-600 shadow-[0_0_20px_rgba(234,88,12,0.8)] animate-pulse',
  },
  {
    id: 'frame_ice',
    name: 'Frostbite',
    type: 'frame',
    price: 750,
    asset: 'ring-4 ring-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.5)]',
  },
  {
    id: 'frame_void',
    name: 'Void Walker',
    type: 'frame',
    price: 2000,
    asset: 'ring-4 ring-purple-900 shadow-[0_0_30px_rgba(88,28,135,0.8)]',
  },
  {
    id: 'title_master',
    name: 'Title: Game Master',
    type: 'title',
    price: 5000,
    asset: 'Game Master',
  },
