...
class VideoProcessor {
  ...
  private processFrame = () => {
    ...
    this.currentCrop.width +=
      (this.targetCrop.width - this.currentCrop.width) * this.smoothingFactor;
    this.currentCrop.height +=
      (this.targetCrop.height - this.currentCrop.height) * this.smoothingFactor;
    ...
    this.ctx.drawImage(
      ...
      this.currentCrop.y,
      this.currentCrop.width,
      this.currentCrop.height, // Source Rect
      0,
      0,
      this.canvas!.width,
      this.canvas!.height // Destination Rect (Full Canvas)
    );
