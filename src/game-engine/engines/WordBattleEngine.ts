...
// --- Constants ---
const WORDS = [
    "BATTLE", "GAMING", "PLAYER", "WINNER", "JUNGLE", "PUZZLE", "ARDENT", "BRIGHT", "CASTLE", "DRAGON",
    "EMPIRE", "FOREST", "GALAXY", "HEROIC", "ISLAND", "JUMPER", "KNIGHT", "LEGEND", "MASTER", "NATURE",
    "ORANGE", "PLANET", "QUESTS", "ROCKET", "SHIELD", "TEMPLE", "UNITED", "VICTORY", "WONDER", "YELLOW",
    "ARCADE", "BOSSES", "CAMERA", "DAMAGE", "ENERGY", "FINISH", "GLOBAL", "HEALTH", "IMPACT", "JOYPAD",
    "LEVELS", "MEMORY", "ONLINE", "PIXELS", "RECORD", "SCREEN", "TARGET", "UNLOCK", "VIDEO", "WORLD"
];
