...
import { Youtube, Upload, Monitor, X, ArrowLeft, Zap, Globe, Loader2 } from 'lucide-react';
            ...
            <div className='flex flex-col'>
              ...
              <TooltipProvider>
                ...
                >
                  ...
                  <TooltipContent
                    side='bottom'
                    className='text-xs bg-black/90 border-white/10 text-white/60'
                  >
              ...
              >
                <div className='grid grid-cols-2 gap-3'>
                  ...
                  >
                    ...
                    <span className='text-[9px] font-black uppercase tracking-widest text-center group-hover:text-white transition-colors'>
                      YouTube
                    </span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setIsLaunching(true);
                      onStartVirtualBrowser();
                      // Show brief launching state, then close
                      setTimeout(() => {
                        setIsLaunching(false);
                        onOpenChange(false);
                      }, 1500);
                    }}
                    className='group relative aspect-square w-full rounded-2xl bg-white/5 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/10 transition-all duration-500 flex flex-col items-center justify-center gap-2 overflow-hidden disabled:opacity-80'
                  >
                    <div
                      className={`w-10 h-10 bg-black/40 rounded-lg flex items-center justify-center transition-all duration-500 ${isLaunching ? 'bg-blue-500' : 'group-hover:scale-110 group-hover:bg-blue-500'}`}
                    >
                      {isLaunching ? (
                    ...
                    <span
                      className={`text-[9px] font-black uppercase tracking-widest text-center transition-colors ${
                        isLaunching ? 'text-blue-300 animate-pulse' : 'group-hover:text-white'
                      }`}
                    >
              ...
              >
                ...
                <form onSubmit={handleYoutubeSubmit} className='space-y-8'>
                  <div className='relative group'>
                    ...
                    <button
                      type='submit'
                      className='absolute right-4 top-4 h-12 px-8 bg-red-500 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-red-600 transition-all shadow-[0_5px_20px_rgba(239,68,68,0.4)] active:scale-95'
                    >
                      Establish Link
                    </button>
                  </div>
