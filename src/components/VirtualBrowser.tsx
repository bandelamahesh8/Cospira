...
export const VirtualBrowser = () => {
  ...
  const [performanceMode, setPerformanceMode] = useState<'quality' | 'balanced' | 'performance'>(
    'balanced'
  );
  ...
  const [tabs, setTabs] = useState<
    Array<{ id: string; url: string; title: string; isLoading: boolean }>
  >([]);
    ...
    <div className='fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4'>
      <div className='bg-[#0F1115] border border-white/10 rounded-2xl p-6 max-w-md w-full shadow-2xl'>
        ...
        <div className='space-y-3 text-sm text-slate-300 mb-6'>
          <p>
            <strong className='text-amber-400'>Audio & Video Quality:</strong> Virtual browser
            streams may have reduced quality and occasional interruptions.
          </p>
          <p>
            <strong className='text-blue-400'>Recommended Alternative:</strong> For the best
            experience, consider using screen sharing instead of the virtual browser.
          </p>
          <p className='text-xs text-slate-500'>
            Screen sharing provides native performance, full audio/video quality, and better
          ...
          <div className='flex gap-0.5 md:gap-1 ml-1 md:ml-2 shrink-0'>
            <Button
              ...
              onClick={() =>
                ...
                socket?.emit('browser-input', {
                  roomId,
                  input: { type: 'navigate', action: 'back' },
                })
              }
            >
              <ChevronLeft size={18} />
          ...
          <div className='h-14 bg-[#0F1115] border-b border-white/5 flex items-center justify-between px-4 relative z-20'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <Button
                ...
                onClick={() =>
                  socket?.emit('browser-input', {
                    roomId,
                    input: { type: 'navigate', url: 'forward' },
                  })
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  socket?.emit('browser-input', {
                    roomId,
                    input: { type: 'navigate', url: virtualBrowserUrl },
                  })
                }
              >
                <RotateCcw size={16} />
            ...
            <div className='flex items-center gap-2'>
              ...
              <div className='flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/5'>
                <div
                  className={`w-2 h-2 rounded-full ${connectionQuality === 'excellent' ? 'bg-green-400' : connectionQuality === 'good' ? 'bg-yellow-400' : 'bg-red-400'}`}
                />
          ...
          <div className='bg-[#0F1115] border-b border-white/5 p-4 animate-in slide-in-from-top duration-200'>
            ...
            <div className='mt-4 pt-4 border-t border-white/5'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div className='space-y-2'>
                  <label className='text-xs font-medium text-slate-400'>
                    Bass Boost: {audioSettings.bassBoost}dB
                  </label>
                  <input
                    type='range'
                    min='-10'
                    ...
                    onChange={(e) =>
                      setAudioSettings((prev) => ({ ...prev, bassBoost: parseInt(e.target.value) }))
                    }
                    className='w-full h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer slider'
                  />
                </div>
                ...
                <div className='space-y-2'>
                  <label className='text-xs font-medium text-slate-400'>
                    Treble Boost: {audioSettings.trebleBoost}dB
                  </label>
                  <input
                    type='range'
                    min='-10'
                ...
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    >
                      <div
                        className={`w-3 h-3 bg-white rounded-full transition-transform ${audioSettings.echoCancellation ? 'translate-x-3' : 'translate-x-0'}`}
                      />
                    </button>
                  </div>
                  <div className='flex items-center justify-between'>
                    ...
                    >
                      <div
                        className={`w-3 h-3 bg-white rounded-full transition-transform ${audioSettings.noiseReduction ? 'translate-x-3' : 'translate-x-0'}`}
                      />
                    </button>
                  </div>
                  <div className='flex items-center justify-between'>
                    ...
                    >
                      <div
                        className={`w-3 h-3 bg-white rounded-full transition-transform ${audioSettings.autoGainControl ? 'translate-x-3' : 'translate-x-0'}`}
                      />
                    </button>
                  </div>
                </div>
            ...
            {(!isConnected || isLoading) && (
              <div className='absolute inset-0 bg-[#000000] z-10 flex flex-col items-center justify-center gap-12 backdrop-blur-3xl overflow-hidden'>
                ...
                <div className='relative w-32 h-32 flex items-center justify-center animate-in zoom-in duration-1000'>
                  ...
                  />
                  <div
                    className='absolute inset-2 rounded-full border border-blue-400/20 border-t-blue-400/80 shadow-[0_0_15px_rgba(96,165,250,0.5)]'
                    style={{ animation: 'spin 3s linear infinite reverse' }}
                  />
                  <Globe
                    size={48}
                    className='text-blue-400 relative z-10 animate-pulse drop-shadow-[0_0_10px_rgba(96,165,250,0.8)]'
                  />
                </div>
                      ...
                      <div className='w-6 h-6 flex items-center justify-center shrink-0 relative'>
                        {startupPhase > p ? (
                          ...
                          <div className='relative flex items-center justify-center'>
                            ...
                            <Loader2
                              size={18}
                              className='text-blue-400 animate-spin relative z-10'
                            />
                          </div>
                        ) : (
                    ...
                    <div className='flex gap-2'>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (!canControl) {
                            toast.error('Control Required', {
                              description: 'Only Host or Co-Hosts can send input.',
                            });
                            return;
                          }
                          if (imeText.trim()) {
