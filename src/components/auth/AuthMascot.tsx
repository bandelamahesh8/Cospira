  ...
  return (
    <div className="relative w-80 h-80 md:w-96 md:h-96 flex items-center justify-center select-none pointer-events-none">
      ...
      <motion.div 
        ...
        animate={{
          opacity: isSuccess ? 0.3 : (isProcessing ? 0.4 : (isHoveringCTA ? 0.3 : (isTyping ? 0.2 : 0.15))),
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <motion.div
           animate={{ 
             ...
             borderColor: isProcessing ? 'rgba(165, 180, 252, 0.6)' : (isHoveringCTA ? 'rgba(255, 255, 255, 0.3)' : 'rgba(255,255,255,0.05)'),
             scale: isProcessing ? 0.98 : 1,
             borderWidth: (isHoveringCTA || isProcessing) ? 1.5 : 1
           }}
           transition={{ 
             rotate: isProcessing ? { duration: 0.4, ease: [0.22, 1, 0.36, 1] } : { duration: rotationDuration * 1.2, repeat: Infinity, ease: "linear" },
        ...
        <motion.div
           ...
           transition={{ 
             rotate: isProcessing ? { duration: 0.5, ease: [0.22, 1, 0.36, 1], delay: 0.05 } : { duration: rotationDuration, repeat: Infinity, ease: "linear" },
             default: { duration: 0.48, ease: [0.22, 1, 0.36, 1] }
           }}
        ...
        <motion.div
           ...
           transition={{ 
             rotate: isProcessing ? { duration: 0.6, ease: [0.22, 1, 0.36, 1], delay: 0.1 } : { duration: rotationDuration * 0.8, repeat: Infinity, ease: "linear" },
