...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({ isOpen, onClose, initialEmail = '' }) => {
    ...
    const handleVerifyOTP = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        const { success, resetToken: token, error: apiError } = await verifyOTP(email, otp, 'forgot_login');
        setIsLoading(false);
                        ...
                        <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                           <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-white/40 uppercase tracking-widest font-medium">Secure Reset Flow</p>
                                </div>
                           </div>
                           <button onClick={onClose} className="rounded-full p-2 hover:bg-white/5 transition-colors text-white/50 hover:text-white">
                               <X className="w-5 h-5" />
                           </button>
                        </div>
                        ...
                        <div className="p-8">
                             ...
                             {step === 1 && (
                                 <form onSubmit={handleRequestOTP} className="space-y-6">
                                     <div className="space-y-2">
                                         <label className="text-[10px] font-bold uppercase tracking-widest text-white/30 ml-1">Account Identifier</label>
                             ...
                             {step === 2 && (
                                 <form onSubmit={handleVerifyOTP} className="space-y-6">
                                     ...
                                     <div className="space-y-2">
                                         <label className="text-[10px] font-bold uppercase tracking-widest text-white/30 ml-1">Verification Code</label>
                                         <Input 
                                             value={otp}
                             ...
                             {step === 4 && (
                                 <div className="flex flex-col items-center justify-center py-6 text-center">
                                     ...
                                     <p className="text-white/60 mb-8">Your account has been successfully secured with the new credentials.</p>
                                     <Button 
                                         onClick={onClose}
