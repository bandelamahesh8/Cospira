...
// REGIONS and getRegionDensity were unused
...
export const LiveMap = () => {
  ...
  return (
    <div
      ref={containerRef}
      className='relative w-full h-[360px] bg-[#020408] rounded-[24px] border border-white/10 overflow-hidden shadow-2xl'
    >
      ...
      <div className='absolute top-8 left-8 flex flex-col gap-6 pointer-events-none'>
        ...
        <div className='flex flex-col gap-1'>
          <div className='flex items-center gap-2'>
            ...
            <h3 className='text-sm font-black text-cyan-400 tracking-[0.2em] uppercase'>
              Global_Intel
            </h3>
          </div>
          <p className='text-[10px] text-cyan-500/50 font-mono pl-4'>
      ...
      <div className='absolute bottom-8 left-8 flex items-end gap-8 z-10'>
        <div>
          ...
          <div className='text-3xl font-black text-white leading-none'>
            12<span className='text-lg text-cyan-500/50'>/12</span>
          </div>
        </div>
        <div>
          <div className='text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1'>
          ...
          <div className='text-3xl font-black text-white leading-none'>
            4.2 <span className='text-sm text-slate-500'>PB/s</span>
          </div>
        </div>
      </div>
