                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-white/40">AI Intelligence Insight</span>
                            </div>
                            ...
                            <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[8px] font-black text-indigo-400/50 uppercase tracking-widest">Neural Link Active</span>
                                </div>
