...
export const AISummaryWidget = ({ summary }: AISummaryWidgetProps) => {
  const defaultSummary = ['Meeting highlights ready', 'Key decisions tracked', 'No risks detected'];
    ...
    >
      ...
      <div className='relative bg-white/5 border border-white/10 rounded-2xl p-4'>
        ...
        <div className='flex items-center gap-2 mb-4'>
          ...
          <h3 className='text-sm font-black uppercase tracking-wider text-white'>AI Summary</h3>
        </div>
