    ...
    >
      ...
      <div className='relative bg-white/5 border border-white/10 rounded-2xl p-4'>
        ...
        <div className='flex items-center gap-2 mb-4'>
          ...
          <h3 className='text-sm font-black uppercase tracking-wider text-white'>Activity</h3>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  <p className='text-xs text-white/70 leading-relaxed'>{activity.message}</p>
                  <p className='text-[10px] text-white/40 mt-0.5'>{activity.timestamp}</p>
                </div>
              </motion.div>
            );
          })}
