...
import { X, Bot, Zap, Sparkles, Gamepad2, Rocket, Brain, Search } from 'lucide-react';
    ...
    items: [
      {
        title: 'Fun Mode',
        description:
          'Optimized for social interactions. Features dynamic filters, casual gaming integration, and relaxed security protocols for high-speed engagement.',
      },
      {
        title: 'Pro Mode',
        description:
          'The gold standard for collaboration. Focused on low-latency screen sharing, high-fidelity audio, and productivity-first UI layouts.',
      },
      {
        title: 'Ultra Mode',
        description:
          'Maximum bandwidth allocation. Utilizes advanced SFU routing for 4K video streams and sub-50ms latency for critical real-time tasks.',
      },
      {
        title: 'Mixed Mode',
        description:
          'Our most versatile state. Automatically balances social features with professional tools based on current room activity.',
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'How to Play',
        description:
          "Open the 'Games' tab in any room to access the engine. Select a title (Chess, Ludo, Battleship) to initialize a synchronized session for all agents.",
      },
      {
        title: 'Engine Features',
        description:
          'Includes real-time state synchronization, ELO-based matchmaking statistics, and move history analysis.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Visit the 'Development' sector to view our live roadmap. Features include AI-driven video synthesis and VR workspace integration.",
      },
      {
        title: 'System Settings',
        description:
          'Customizable via the gear icon. Control neural filters, audio suppression, and global privacy settings.',
      },
      {
        title: 'Agent Profile',
        description:
          'Your digital identity. Manage your DiceBear avatar, display name, and historical contribution stats.',
      },
    ],
  },
];
                  ...
                  <div key={idx} className='space-y-4'>
                    ...
                    <div className='grid grid-cols-1 gap-3'>
                      {cat.items.map((item, i) => (
                        ...
                        >
                          <h4 className='text-sm font-black text-white uppercase italic mb-2 group-hover:text-indigo-400 transition-colors'>
                            {item.title}
                          </h4>
                ...
                {filteredKnowledge.length === 0 && (
                  <div className='py-20 text-center'>
                    ...
                    <p className='text-[10px] font-black text-white/20 uppercase tracking-widest'>
                      No matching neural patterns found
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className='p-6 bg-white/[0.02] border-t border-white/5 flex justify-between items-center'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-[9px] font-black text-white/30 uppercase tracking-[0.2em]'>
                  Always learning provided by Cospira Intelligence
                </span>
              </div>
