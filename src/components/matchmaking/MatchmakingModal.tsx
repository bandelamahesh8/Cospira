                  ...
                  {games.map((game) => (
                    ...
                    >
                      <div className='flex items-center gap-3'>
                        <div
                          className={cn('text-4xl bg-gradient-to-br p-3 rounded-xl', game.color)}
                        >
                          {game.icon}
                        </div>
                        <div>
                ...
                <div className='grid grid-cols-2 gap-3'>
                  ...
                  >
                    <div className='flex flex-col items-center gap-2'>
                      ...
                      <p className='text-xs text-slate-400 text-center'>For fun • No ELO changes</p>
                      <div className='mt-2 px-3 py-1 bg-slate-800 rounded-full'>
              ...
              <div className='flex flex-col items-center gap-6'>
                ...
                <div className='text-center'>
                  ...
                  <p className='text-slate-400'>
                    {mode === 'ranked'
                      ? 'Finding player with similar ELO'
                      : 'Finding any available player'}
                  </p>
                </div>
                ...
                <div className='flex items-center gap-4 px-6 py-3 bg-slate-900 rounded-xl border border-slate-700'>
                  ...
                  <div className='text-center'>
                    ...
                    <p className='text-2xl font-mono font-bold text-slate-400'>~{estimatedWait}s</p>
                  </div>
                </div>
