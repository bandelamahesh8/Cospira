              ...
              {requests.length > 0 && (
                <div className='mb-6 space-y-3'>
                  ...
                  {requests.map((req) => (
                    <div
                      key={req.id}
                      className='flex items-center justify-between bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 p-3 rounded-xl transition-all group'
                    >
                      <div className='flex items-center gap-3'>
                        <Avatar className='w-8 h-8 ring-2 ring-orange-500/20'>
                          <AvatarImage src={req.avatarUrl} />
                          <AvatarFallback className='bg-orange-950 text-orange-500 text-xs font-bold'>
                            {req.username[0]}
                          </AvatarFallback>
                        </Avatar>
                  ...
                  >
                    <div className='relative'>
                      <Avatar className='w-9 h-9 border border-white/10 group-hover:border-purple-500/50 transition-colors'>
                        ...
                        <AvatarFallback className='bg-slate-900 text-slate-500 text-xs font-bold'>
                          {friend.username[0]}
                        </AvatarFallback>
                      </Avatar>
                      <div
          ...
          <TabsContent value='add' className='mt-4 focus-visible:outline-none'>
            <div className='flex gap-2 mb-6'>
              ...
              <Button
                ...
                className='h-9 w-9 bg-purple-600 hover:bg-purple-500 text-white border border-purple-400/30'
              >
            ...
            <ScrollArea className='h-[350px]'>
              {searchResults.map((user) => (
                <div
                  key={user.id}
                  className='flex items-center justify-between p-3 hover:bg-white/5 rounded-xl border border-transparent hover:border-white/10 transition-all mb-2'
                >
                  <div className='flex items-center gap-3'>
