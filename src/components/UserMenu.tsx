  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuItem
          onClick={signOut}
          className='group flex items-center gap-2 p-2 rounded-lg focus:bg-red-500/10 cursor-pointer text-white/30 hover:text-red-400 transition-colors mt-1'
        >
          <LogOut className='w-3.5 h-3.5' />
          <span className='text-[10px] font-black uppercase tracking-widest group-hover:text-red-400'>
            Sign Out
          </span>
        </DropdownMenuItem>
      </DropdownMenuContent>
