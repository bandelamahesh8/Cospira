        ...
        <div className="flex items-center gap-4">
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <button
                        className="w-9 h-9 rounded-lg bg-gradient-to-br from-purple-500 to-cyan-500 flex items-center justify-center font-bold text-white text-xs shadow-lg shadow-purple-500/20 hover:scale-105 transition-transform"
                    >
                        <img 
                ...
                <PopoverContent className="bg-[#0A0A0A] border-white/10 p-2 w-auto mr-4" align="end" sideOffset={8}>
