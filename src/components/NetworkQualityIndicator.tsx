  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            className={`flex items-center justify-center h-8 w-8 rounded-full ${getColor()} cursor-help transition-all duration-500`}
          >
            {getIcon()}
          </div>
        </TooltipTrigger>
        ...
        >
          <div className='text-xs space-y-1 p-1'>
            ...
            <p className='text-[10px] text-white/70 italic border-l-2 border-white/20 pl-2 my-2'>
              {recommendation}
            </p>
