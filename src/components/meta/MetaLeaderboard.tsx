            ...
            <div className="space-y-2">
                ...
                {players.map((p, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-16 text-center font-bold text-xl ${rankColor}`}>
                                #{rank}
                            </div>
                            
                            <div className="flex-1 flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-slate-800 overflow-hidden border border-slate-700">
                                    <img src={p.avatar_url || `https://api.dicebear.com/7.x/avataaars/svg?seed=${p.username}`} className="w-full h-full object-cover" />
                                </div>
                                <div>
                            ...
                            <div className="w-32 text-center">
                                <Badge variant="outline" className="bg-slate-800 border-indigo-500 text-indigo-400 font-bold text-lg px-3 py-1">
                                    {p.oss}
                                </Badge>
                            </div>
