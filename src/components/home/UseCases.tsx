    ...
    <section className="hp-section overflow-hidden">
      ...
      <div className="hp-container relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          ...
          >
            Cospira adapts its core engine to fit the specific constraints of your session, 
            ensuring maximum intelligence and zero overhead.
          </motion.p>
        </div>
            ...
            >
              <div className="relative h-full rounded-[1.5rem] border-[0.75px] border-white/5 p-2 md:p-3">
                ...
                <div className="relative h-full overflow-hidden rounded-2xl border-[0.75px] bg-[#05060c] p-8 shadow-sm transition-colors duration-500 group">
                  <div className="flex flex-col h-full relative z-20" style={{ transformStyle: 'preserve-3d' }}>
                    <div className="flex justify-between items-start mb-12">
                      ...
                      <DepthLayer depth={20} className="font-mono text-[10px] text-white/10 uppercase tracking-[0.2em]">
                        Case Study 0{i + 1}
                      </DepthLayer>
                    </div>
                    ...
                    <div className="mt-auto">
                      <DepthLayer depth={40}>
                        <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic mb-4">{uc.label}</h3>
                      ...
                      <DepthLayer depth={30} className="flex flex-wrap gap-2">
                        {uc.features.map(f => (
                          <span key={f} className="px-3 py-1 rounded-full border border-white/5 bg-white/[0.02] text-[9px] font-bold text-white/30 uppercase tracking-widest group-hover:text-white/60 group-hover:border-white/10 transition-colors">
                            {f}
                          </span>
                        ))}
                      </DepthLayer>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-20">
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="text-3xl font-black text-white uppercase tracking-tighter italic mb-2">
                      Essentially, <span className="hp-grad-cyan">Everything.</span>
                    </h3>
                    <p className="text-lg text-white/40 leading-relaxed font-medium">
                      Work together, watch together, explore together, and build together. 
                      Cospira turns the web into a shared experience where people connect, 
                      interact, and create in real time. Open to anyone with emotions to share — 
                      so robots? Keep quite!.
                    </p>
                  </div>
