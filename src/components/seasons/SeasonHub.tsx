            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="lg:col-span-3">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                        ...
                        {[6,7,8,9,10].map(i => (
                             <Card key={i} className="min-w-[160px] p-4 flex flex-col items-center bg-slate-900 border-slate-700 opacity-50">
                                  <div className="absolute top-2 right-2 text-xs font-bold text-slate-500">Lvl {i}</div>
                                  <div className="w-16 h-16 rounded-lg bg-slate-800 mb-3 mt-4 flex items-center justify-center">?</div>
                                  <div className="flex items-center gap-1 text-xs text-slate-500 font-bold uppercase py-2">Coming Soon</div>
                             </Card>
                        ))}
                    </div>
                </div>
