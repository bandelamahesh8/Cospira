    ...
    <AnimatePresence>
      {(showChat || isEmbedded) && (
        <motion.div
          ...
          animate={isEmbedded ? { opacity: 1 } : { opacity: 1, scale: 1, y: 0 }}
          exit={isEmbedded ? { opacity: 0 } : { opacity: 0, scale: 0.9, y: 20 }}
                    ...
                    >
                      ...
                      {isFileItem ? (
                        (() => {
                          ...
                          return (
                            <div
                              className={`p-1 rounded-2xl border transition-all ${isMe ? 'bg-indigo-500/10 border-indigo-500/20 rounded-tr-sm' : 'bg-white/5 border-white/10 rounded-tl-sm'}`}
                            >
