                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0 pt-0.5">
                      <div className="flex items-center gap-2 mb-1.5">
                        <span className="text-xs font-bold text-white/50 uppercase tracking-wide">Suggesting</span>
                        <ArrowRight className="w-3 h-3 text-white/20" />
                        <span className="text-xs font-black text-indigo-400 uppercase tracking-widest bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20 shadow-[0_0_10px_rgba(99,102,241,0.1)]">{config.label}</span>
                      </div>
