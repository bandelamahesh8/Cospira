                    ...
                    <div className="relative z-10 w-full max-w-lg p-6">
                        <div className="border border-red-500/30 bg-black/90 backdrop-blur-xl rounded-xl p-8 shadow-[0_0_50px_rgba(239,68,68,0.2)]">
                            ...
                            <div className="flex items-center gap-4 mb-8 border-b border-red-500/20 pb-4">
                                <div className={`p-3 rounded-full border ${step === 'success' ? 'border-emerald-500/50 bg-emerald-500/10' : 'border-red-500/50 bg-red-500/10'}`}>
                                    {step === 'success' ? (
                                ...
                                <div>
                                    <h2 className={`text-xl font-bold tracking-[0.2em] ${step === 'success' ? 'text-emerald-500' : 'text-red-500'}`}>
