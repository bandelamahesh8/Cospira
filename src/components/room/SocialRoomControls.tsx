        ...
        <TooltipProvider delayDuration={0}>
            ...
            >
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="right" sideOffset={20} className="bg-black/90 border border-red-500/20 text-white p-3 rounded-xl shadow-2xl backdrop-blur-xl">
                        <div className="flex flex-col">
                            <span className="text-[10px] uppercase font-black tracking-widest text-red-500 mb-0.5">Emergency</span>
                 ...
                 {onSkip && (
                    <Tooltip>
                        ...
                        <TooltipContent side="right" sideOffset={20} className="bg-black/90 border border-emerald-500/20 text-white p-3 rounded-xl shadow-2xl backdrop-blur-xl">
                            <div className="flex flex-col">
                                <span className="text-[10px] uppercase font-black tracking-widest text-emerald-500 mb-0.5">Next Match</span>
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="right" sideOffset={20} className="bg-black/90 border border-white/10 text-white p-3 rounded-xl shadow-2xl backdrop-blur-xl">
                         <div className="flex flex-col">
                            <span className="text-[10px] uppercase font-black tracking-widest text-white/50 mb-0.5">Safety Protocol</span>
