...
export const AuthPromptModal = ({ open, onOpenChange, triggerActivity }: AuthPromptModalProps) => {
    ...
    const content = {
        microphone: {
            ...
            description: "Claim your voice. Create an account to customize your audio profile and save preferences.",
            icon: Mic,
            color: "from-blue-500 to-indigo-500"
        },
        camera: {
            title: "Visual Presence",
            description: "Show up in style. Create an account to save your avatar preferences and access pro video features.",
            icon: Sparkles, // Or Video/Camera if I want to import it, but Sparkles is already there and fits "style"
            color: "from-red-500 to-rose-600"
        },
        chat: {
            title: "Secure Comms",
            description: "Sign up to save this conversation history and access it later in your dashboard.",
            icon: MessageSquare,
            color: "from-purple-500 to-pink-500"
        },
        summary: {
            title: "Unlock Intelligence",
            description: "AI Summaries are exclusive to members. Create a free account to generate instant meeting notes.",
            icon: Sparkles,
            color: "from-amber-400 to-orange-500"
        },
        timer: {
            title: "Permanent Access",
            description: "Enjoying the space? Sign up to create your own permanent arenas and keep your identity.",
            icon: Clock,
