        ...
        <div className='p-8 space-y-8 relative'>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-3'>
              <StatusCard icon={Lock} label='Encryption' value='End-to-End' active />
              <StatusCard icon={Shield} label='Protection' value='Active' active />
              <StatusCard
                icon={Activity}
                label='Uptime'
                value='99.9%'
...
const StatusCard = ({
  ...
  <div className='p-3 rounded-xl bg-white/5 border border-white/5 flex items-start gap-3 hover:bg-white/10 transition-colors group'>
    <div
      className={`mt-0.5 w-6 h-6 rounded-lg ${active ? 'bg-emerald-500/20 text-emerald-400' : 'bg-white/5 text-white/30'} flex items-center justify-center shrink-0`}
    >
