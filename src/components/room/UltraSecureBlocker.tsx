      ...
      >
        ...
        >
          ...
          <p className='text-white/50 font-medium mb-8 text-sm leading-relaxed'>
            The Secure environment requires a persistent fullscreen connection. External window
            interactions have been locked to prevent data leaks.
          </p>
          ...
          <div className='flex flex-col gap-6 p-6 rounded-2xl bg-white/[0.03] border border-white/5 mb-8'>
            <div className='flex items-center justify-between'>
              ...
              <span
                className={`text-xl font-mono font-black ${chances <= 1 ? 'text-red-500' : 'text-orange-400'}`}
              >
                {chances} / 3
              </span>
            </div>
