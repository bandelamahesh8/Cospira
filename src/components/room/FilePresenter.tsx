        ...
        <div className="w-full h-full flex flex-col relative group overflow-hidden">
            ...
            <div className="absolute top-8 left-8 z-30 flex flex-col">
                <div className="flex items-center gap-3 px-3 py-1.5 bg-primary/10 border border-primary/20 rounded-xl mb-2 w-fit">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Manifested Object</span>
                </div>
                <h3 className="text-3xl font-black uppercase italic tracking-tighter text-white drop-shadow-2xl">
                    {file.name}
                </h3>
                <div className="flex items-center gap-4 mt-2">
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Size: {formatSize(file.size)}</span>
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/40">|</span>
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Subject: {file.userName}</span>
                </div>
            </div>
                    ...
                    {isImage ? (
                        ...
                        >
                            ...
                            <div className="absolute top-4 left-1/2 -translate-x-1/2 px-4 py-2 luxury-glass border border-white/10 rounded-full flex items-center gap-4 pointer-events-auto">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[8px] font-black uppercase tracking-widest text-white/60">PDF Projection</span>
                                </div>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <h4 className="text-xl font-black uppercase italic tracking-tighter text-white">Encrypted Data Stream</h4>
                                <p className="text-sm font-medium text-slate-400">This object is currently non-renderable in this viewport. Acquire the asset to view locally.</p>
                            </div>
