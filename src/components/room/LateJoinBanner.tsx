        ...
        <div className="relative p-4 flex items-center gap-5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-400">AI Context</span>
            ...
            <p className="text-sm font-medium text-slate-300 truncate tracking-wide">
              {summary}
            </p>
          </div>
