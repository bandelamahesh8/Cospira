                    ...
                    >
                      ...
                      <div className="flex-1 text-left relative z-10">
                        <div className="flex items-center gap-2">
                          ...
                          {modeId === 'ultra' && (
                             <span className="px-1.5 py-0.5 bg-red-500/20 text-red-400 text-[9px] font-black uppercase rounded border border-red-500/20">Secure</span>
                          )}
                        </div>
                        <p className="text-xs text-white/40 mt-0.5 font-medium">{config.description}</p>
                      </div>
