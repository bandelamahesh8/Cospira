        ...
        <Command className='bg-transparent'>
          <CommandList>
            <CommandInput
              ...
              className='h-10 text-[10px] uppercase font-bold tracking-widest text-white/50 border-white/5'
            />
            <CommandEmpty className='py-4 text-center text-xs text-white/30'>
